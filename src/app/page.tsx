...
export default function Home() {
    ...
    <div className="p-8 space-y-12">
      ...
      <motion.section className="text-center" {...fadeInUp}>
        <div className="flex flex-col items-center">
          ...
          <h1 className="text-5xl font-extrabold text-emerald-600 mb-4 fancy-font my-8">
            Our Wedding!
          </h1>
        </div>
        ...
        <div className="my-0 relative">
          ...
          {/* Floating quotes */}
          <span
            className="absolute top-0 left-1/2 -translate-x-1/2 bg-white/80 px-3 py-1 rounded-full shadow-lg text-sm animate-float"
            style={{ zIndex: 2 }}
          >
            🍷 “Come support the couple!”
          </span>
          <span
            className="absolute bottom-0 left-1/2 -translate-x-1/2 bg-white/80 px-3 py-1 rounded-full shadow-lg text-sm animate-float"
            style={{ zIndex: 2 }}
          >
            🍽️ “Let’s feast together!”
          </span>
          <span
            className="absolute left-0 top-1/2 -translate-y-1/2 bg-white/80 px-3 py-1 rounded-full shadow-lg text-sm animate-float"
            style={{ zIndex: 2 }}
          >
            🥂 “Cheers to a thousand toasts!”
          </span>
          <style jsx>{`
            .animate-float {
      ...
      <motion.section className="text-center" {...fadeInUp}>
        <div className="flex flex-col items-center leading-relaxed gap-2 overflow-visible">
          {/* Groom */}
          <p
            className="text-3xl meaculpa-font tracking-wider font-semibold text-center 
      ...
      {/* Poem Section */}
      <motion.section
        className="text-center italic text-lg Edu-font"
        {...fadeInUp}
      >
        <p>
      ...
      <motion.section className="text-center" {...fadeInUp}>
        <div className="relative my-6">
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(circle, rgba(246,240,213,0) 50%, rgba(246,240,213,0.8) 100%)",
            }}
          ></div>
        </div>
      ...
      <motion.section className="text-sm" {...staggerContainer}>
        ...
        <div className="text-left space-y-6 leading-relaxed">
          <motion.p
            className="text-base Edu-font text-justify space-y-10 leading-[1.8]"
            {...fadeInUp}
          >
            Dear Family &amp; Friends,
            <br />
            &emsp;&emsp;Your presence is the most precious gift we could ask
            for, and if you wish to bless us with something extra, we&apos;ve
            put together a thoughtful gift registry.
            <br />
            &emsp;&emsp;Each option is meaningful to us, rooted in tradition,
            growth, and heartfelt memories.
            <br />
            Feel free to choose what resonates most with you.
          </motion.p>
          <motion.div {...fadeInUp}>
            <h3 className="text-lg font-semibold mb-1 leading-[1.8]">
              Gift with Tradition
            </h3>
            <p className="text-base Edu-font text-justify leading-[1.8]">
              &emsp;&emsp;If you prefer to bless us with a precious metal or
              cash gift, we deeply appreciate it. You can do so during the
              event.
            </p>
          </motion.div>
          <motion.div {...fadeInUp}>
            ...
            <ul className="list-disc list-inside ml-4 Edu-font text-base leading-[1.8]">
              <li>
                <a
                  href="https://www.caratlane.com/caratlane-digital-gold?srsltid=AfmBOoqcyKK0Gh8cFi2qbf8CT1CH1SLzQ5U7-dBGOZfXxhNl6U5C7JGw"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-emerald-600 hover:underline"
                >
                  Click here to gift digital gold
                </a>
              </li>
            </ul>
            <p className="Edu-font text-base">Share the gift card number</p>
            <input
              type="text"
          ...
          <motion.div {...fadeInUp}>
            ...
            <p className="Edu-font text-base">
          ...
          <motion.div {...fadeInUp}>
            <h3 className="text-lg Edu-font font-semibold mb-1 leading-[1.8]">
              Something Personal or Handmade?
            </h3>
            <p className="text-base text-justify Edu-font leading-[1.8]">
              Got something handmade, heartfelt, or meaningful? We would be
              honored to receive it as your love will always have a place in our
              hearts and home.
            </p>

            {/* Map Section */}
            <motion.section className="text-center" {...zoomIn}>
              <p className="mb-2 text-sm my-6">
                [Tap or click the map for navigation ↓]
              </p>
              <a
            ...
            {/* Second Poem Section */}
            <motion.section
              className="text-center italic text-lg Edu-font my-3"
              {...fadeInUp}
            >
              <p>
            ...
            {/* RSVP Section */}
            <motion.section {...fadeInUp}>
              <h2 className="text-4xl font-bold text-center fancy-font mb-4 my-10">
              ...
              <form
                ...
                onSubmit={(e) => {
                  ...
                  const telephone = (
                    form.elements.namedItem("telephone") as HTMLInputElement
                  ).value;
                  const pax = (
                    form.elements.namedItem("pax") as HTMLInputElement
                  ).value;
              ...
              >
                ...
                <p className="text-center mb-4 text-xs">
                  <br></br>Kindly RSVP by Nov 1st, 2025
                </p>
                <div className="text-center pt-2">
                  <button
                    type="submit"
                    className="px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-[#3c9e5e] hover:bg-[#2b7445] transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500"
                  >
                    RSVP Now
                  </button>
                </div>
            ...
            >
              <motion.p
                ...
                {...fadeInUp}
              >
                Thank you for being a part of this beautiful journey with us.
                Whether it’s your blessings, your presence, or a thoughtful
                contribution, we are truly grateful. This celebration is as much
                about family and friendship as it is about the two of us, and we
                feel elated to share this moment with you!
              </motion.p>
            </div>

            <motion.div
              className="text-4xl text-center font-semibold text-md meaculpa-font tracking-wider leading-[1.8] mt-6"
              {...fadeInUp}
            >
              {/* Salutations */}
              <div className="flex items-center justify-center">
  ...
  return (
    <main
      ...
      style={{
        backgroundImage:
          "url(https://i.pinimg.com/1200x/c0/a4/7a/c0a47aac651b602e2db89164dcadd952.jpg)",
    ...
    >
      ...
      <div style={{ position: "relative", zIndex: 1, width: "100%" }}>
        ...
        {isMobile ? (
          <div
            className="no-scrollbar overflow-y-auto scrollbar-hide h-screen w-full font-serif text-gray-800"
            style={{
              backgroundImage:
                "url(https://i.pinimg.com/736x/d7/77/37/d77737cae1098d5453573c53250f0d1c.jpg)",
